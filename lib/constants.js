...
const EXPANSIONS = [ // {{{
  { eid: EID_BASIC, name: '基本セット', symbol: '基本' },
  { eid: EID_FAREAST, name: '極東辺境領', symbol: '極東' },
  { eid: EID_NORTHERN, name: '北限の魔女', symbol: '北限' },
  { eid: EID_FAIRY, name: 'フェアリーガーデン', symbol: 'ＦＧ' },
  { eid: EID_SIX, name: '六都市同盟', symbol: '六都' },
  { eid: EID_STAR, name: '星天前路', symbol: '星天' },
