...
// sid: Supply ID
//   dsid: Dynamic Supply ID (e.g. random10)
...
//   apid: Actual Page ID (PID without parameters - e.g. "supplies" for "supplies:basic")
...
export function cidsFromPid (pid) {
  ...
  return delayedCids !== undefined ? force(delayedCids) : undefined
}

export function isCardListPid (pid) {
  // TODO: Support supply:random10
